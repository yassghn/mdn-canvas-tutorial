...
const basicDrawingAndShapes = {
	...
	renderBezierAndQuadraticCurves(cvs, textEffect) {
		...
		const text = 'TODAYS NEWS @7: up next on chopped:...and today\'s secret ingredient is...live pussy bitch boys...what will our contenstants put up on THE CHOPPING BLOCK?!'
